...
if (db.getUser("springboot-mydatabase") == null) { db.createUser({ user: "springboot-mydatabase", pwd: "password", roles: [ {"role": "readWrite", "db": "mydatabase"}, {"role": "read", "db": "admin"}, {"role": "read", "db": "config"} ] }); }
